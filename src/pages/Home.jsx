      ...
      <div className="text-center space-y-8">
        <div className="relative">
          <h1 className="text-6xl sm:text-8xl font-black mb-4">
            ...
            <br/>
            <span className="bg-gradient-to-br from-orange-500 via-pink-500 to-red-500 bg-clip-text text-transparent">
              Toast
            </span>
          </h1>
          ...
          <div className="absolute -bottom-2 -left-8 w-12 h-12 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full animate-pulse opacity-70"></div>
        </div>
        
        <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Beautiful, customizable toast notifications with seamless promise handling 
          and vibrant animations ✨
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button
            onClick={() => customToast.success('Welcome to the future of toasts! 🎉')}
            className="px-8 py-4 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
            <span className="mr-2">✨</span>
            Try Now
          </button>
      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 sm:p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="bg-gray-800 rounded-2xl p-6 font-mono text-sm overflow-x-auto">
            ...
            <div className="mt-2 text-yellow-400">customToast<span className="text-white">.</span><span className="text-red-400">error</span><span className="text-white">(</span><span className="text-green-400">'Oops! Something went wrong'</span><span className="text-white">)</span></div>
