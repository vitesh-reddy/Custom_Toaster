...
const Playground = () => {
  ...
  const handleSequentialSuccess = () => {
    ...
    setTimeout(() => {
      customToast.endLoadAndSuccess("Payment successful! 💳✨");
    }, 3000);
  };
  ...
  const ToastButton = ({ onClick, className, icon, title, description }) => (
    <div className="group">
      <button
        onClick={onClick}
        className={`w-full p-6 rounded-2xl font-bold text-white shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 ${className}`}
      >
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-16">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <ToastButton
          onClick={() => customToast.success("Great job! Keep it up! 🎉")}
        ...
        <ToastButton
          onClick={() => customToast.error("Oops! Something went wrong 😅")}
        ...
        <ToastButton
          onClick={() => customToast.loading("Working on it... ⚡")}
        ...
        <ToastButton
          ...
          className="bg-gradient-to-br from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700"
          icon="⚠️"
      ...
      <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 border border-gray-200">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">Control and customize your toast experience</p>
          </div>
          <button
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <button
            onClick={() => customToast.success("This will stick around for 10 seconds! ⏰", { duration: 10000 })}
          ...
          <button
            onClick={() => customToast.success("Quick! ⚡", { duration: 1000 })}
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
          ...
          <div className="space-y-3 text-emerald-700">
            ...
            <p className="flex items-start">
              <span className="text-emerald-500 mr-2">•</span>
              <span className="text-sm">File upload progress → result</span>
            </p>
            <p className="flex items-start">
              <span className="text-emerald-500 mr-2">•</span>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200">
          ...
          <div className="space-y-3 text-blue-700">
            ...
            <p className="flex items-start">
              <span className="text-blue-500 mr-2">⚡</span>
              <span className="text-sm">Choose based on your use case!</span>
            </p>
          </div>
        </div>
      </div>
